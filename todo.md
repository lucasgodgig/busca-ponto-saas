...
- [x] AddressSearch perde foco a cada letra digitada - input fecha e precisa clicar denovo - CORRIGIDO (removido event listener duplicado, usando apenas onChange, handleBlur otimizado para mobile, adicionado onTouchStart para mobile)
